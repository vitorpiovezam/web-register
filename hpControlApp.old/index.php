        ...
        <aside class="row">
            ...
            <aside class="col-md-6"> <!-- VERIFICAÇÃO -->
                ...
                <aside class="menuOpcao">
                    ...
                    <aside class="titulo">Verificações</aside>
                    <li><button class="btn" data-toggle="modal" data-target="#visualizarTabela">Visualizar Tabela</button></li>
                    <li><button class="btn" data-toggle="modal" data-target="#pesquisa">Pesquisa</button></li>
                </aside>
            ...
            <aside class="col-md-6">  <!-- SECOND COL FIRST ROW, Adicionar -->
                ...
                <aside class="menuOpcao">
                    <aside class="titulo">Adicionar dados na buceta da tabela</aside>
            ...
            <aside class="col-md-6">  <!-- FIRS COL SECOND COL-->
                <aside class="menuOpcao">
                    <aside class="titulo">Remover dado da tabela</aside>
                      ...
                      <li><button class="btn" data-toggle="modal" data-target="#removerPorEmpresa">Remover por ID</button></li>
      ...
      <aside class="modal-content">
        ...
        <aside class="modal-body">
          <aside class="form-control">
            <a href="actions/visualizaWeb.php"><aside class="option">Visualizar por Empresa</aside></a>
          </aside>
          <aside class="form-control">
            <a href="actions/visualizaWebNome.php"><aside class="option">Visualizar por Nome</aside></a>
          </aside>
        </aside>
      </aside>
    </form>
  ...
  <aside class="modal-dialog modal-md">
      <aside class="modal-content" style="padding: 20px;">
        ...
        <aside class="modal-body" style="padding: 10px;">
                <center>
                  <form id="pesquisa" action="actions/visualizaPesquisa.php" class="form">
                    <aside class="form-group">

                        <input type="text" name="getPesquisa">
                        <br>
                        <br>
